  ...
  return {
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSPhotoLibraryUsageDescription:
          'Code Puppy needs photo library access so you can attach screenshots and photos to chats.',
      },
    },
    android: {
    ...
    plugins: [
      [
        'expo-router',
        {
          origin: process.env.EXPO_PUBLIC_WEB_ORIGIN || 'https://albertoroca96.github.io',
        },
      ],
    ],
    extra: {
      ...
      supabaseUrl:
        ...
        'https://apalydgxzngsmzxgldlz.supabase.co',
